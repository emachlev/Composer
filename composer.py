...
def get_melody_from_expression(exp):
    ...
    for note in exp:
        ...
        if note == "R1":
            melody.append(music21.note.Rest(type="quarter"))  # These rests are way too long so we treat them as short ones
        elif note == "R2":
            melody.append(music21.note.Rest(type="eighth"))   # These rests are way too long so we treat them as short ones
        elif note == "R4":
